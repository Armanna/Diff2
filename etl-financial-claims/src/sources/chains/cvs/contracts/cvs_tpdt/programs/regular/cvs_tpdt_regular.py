...
def brand_generic_indicator_cvs_tpdt_regular_vectorized(df):
    condition_1 = (df['claim_date_of_service'] < pd.to_datetime('2024-04-01 00:00:00')) | (df['valid_from'] < pd.to_datetime('2024-04-01 11:54:37'))
